...
function Situation (outStream) {
  if (!(this instanceof Situation)) return new Situation(outStream)
...
Situation.prototype.getUpdateString = function() {
  var uobj = {}
  var _this = this
